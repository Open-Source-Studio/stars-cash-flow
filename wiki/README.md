...
Tutorials, integration recipes and deep dives. The compact reference lives in [`docs/`](../docs/); this folder is for material that benefits from a few more paragraphs.

These pages also mirror to the [GitHub Wiki](https://github.com/Open-Source-Studio/stars-cash-flow/wiki) so they show up under per-page URLs that search engines index individually.
